...
export const NodeConfigPanel: React.FC = () => {
    ...
    const renderForm = () => {
      switch (selectedNode.type) {
        case 'start':
          return <StartNodeForm nodeId={selectedNode.id} initialData={selectedNode.data} />;
        case 'task':
          return <TaskNodeForm nodeId={selectedNode.id} initialData={selectedNode.data} />;
        case 'approval':
          return <ApprovalNodeForm nodeId={selectedNode.id} initialData={selectedNode.data} />;
        case 'automated':
          return <AutomatedStepNodeForm nodeId={selectedNode.id} initialData={selectedNode.data} />;
        case 'end':
          return <EndNodeForm nodeId={selectedNode.id} initialData={selectedNode.data} />;
        default:
